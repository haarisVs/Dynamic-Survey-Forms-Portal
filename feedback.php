                				...
                				<div class="modal fade" id="modal-view-<?php echo $value['formId'] ?>"><?php $value['formId'];
							        ...
							        <div class="modal-dialog">
							          <div class="modal-content">
							            ...
							            <form role="form" method="POST" action="fbprocess.php">
						                    <div id="form" class="card-body">
                                  <div class="col-sm-12">
                                    <div class="form-group">
<!--                                       <label for="exampleInputEmail1">Form Id</label> -->
                                      <input type="text" class="form-control" name="formId" value="<?php echo $formData[0]['formId']; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="user_city" placeholder="City">
						                      ...
						                      <?php foreach ($formData as $key => $value): ?>
						                        <div class="col-sm-12">
						                        <div class="form-group">
                                        <input type="text" class="form-control" name="QuestionId[]" value="<?php echo $value['formQuestionId']; ?>">
