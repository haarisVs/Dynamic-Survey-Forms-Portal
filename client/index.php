    ...
    <div class="card-body login-card-body">
      ...
      <form action="process.php" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" id="username" name="clientUsername" placeholder="username">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" id="password" name="clientPassword" placeholder="Password">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" name="clientLogin" class="btn btn-primary btn-block">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      ...
      <p class="mb-0">
        <a href="locreg.php" class="text-center">Register a new </a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
